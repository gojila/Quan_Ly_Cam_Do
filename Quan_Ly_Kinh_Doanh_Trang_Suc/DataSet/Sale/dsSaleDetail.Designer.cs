...
SELECT SaleDetailID, SaleID, SaleCode, ItemBarcode, ItemID, ItemCode, ItemName, GoldType, TotalWeight, GoldWeight, StoneWeight, Price, LaborFee, Amount, Descriptions, IsDeleted, CreatedUserID, CreatedDate, ModifiedUserID, ModifiedDate, DeletedUserID, DeletedDate FROM Sale_Detail WHERE (SaleDetailID = SCOPE_IDENTITY())";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT SaleDetailID, SaleID, SaleCode, ItemBarcode, ItemID, ItemCode, ItemName, GoldType, TotalWeight, GoldWeight, StoneWeight, Price, LaborFee, Amount, Descriptions, IsDeleted, CreatedUserID, CreatedDate, ModifiedUserID, ModifiedDate, DeletedUserID, DeletedDate FROM Sale_Detail WHERE (SaleID = @SaleID)";
