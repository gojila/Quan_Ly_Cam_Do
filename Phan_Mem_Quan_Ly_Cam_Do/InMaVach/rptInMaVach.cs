...
{
    public partial class rptInMaVach : DevExpress.XtraReports.UI.XtraReport
    {
        public rptInMaVach()
        {
            InitializeComponent();
        ...
        public rptInMaVach(DataTable dt, string tenTiem, string diaChi)
        {
            InitializeComponent();
        ...
        public rptInMaVach(string tenTiem, string diaChi, string maVach, string tenHang, decimal tongTrongLuong, decimal trongLuong, decimal tienCong, decimal hot, string loaiVang, string nhaCungCap, string hamLuongPho, int soLuongTem)
        {
            InitializeComponent();
