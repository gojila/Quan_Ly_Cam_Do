...
namespace Phan_Mem_Quan_Ly_Cam_Do.GiaoDienChinh
{
    public partial class DanhSachChucNang : RibbonForm
    {
        ...
        private frmQuanLyInTem _frmQuanLyInTem;
        private void bbiInMaVach_ItemClick(object sender, ItemClickEventArgs e)
        {
            if (_frmQuanLyInTem == null)
            {
                _frmQuanLyInTem = new frmQuanLyInTem();
                _frmQuanLyInTem.FormClosing += (ss, ex) =>
                {
                    _frmQuanLyInTem = null;
                };
                _frmQuanLyInTem.MdiParent = this;
                _frmQuanLyInTem.Show();
            }
            else
            {
                tabMdi.Pages[_frmQuanLyInTem].MdiChild.Activate();
            }
        }        
